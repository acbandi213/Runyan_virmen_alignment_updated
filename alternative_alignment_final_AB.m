%% provide all inputs
info.mousename = 'HX-12-3L';%;
info.mouse = info.mousename;
info.date = '2024-06-03'; %;
info.server = '/Volumes/Akhil Data'; %/Volumes/Runyan5
runyan5 = "/Volumes/Runyan5:";
runyan4 = '/Volumes/Runyan4';
data_base = 'CBHX-12-3L_240522';%;
info.experimenter_name = 'Akhil';
...
info.sync_base_path = ['/Volumes/Akhil Data/Akhil/RawData/' info.mousename '/wavesurfer/' info.date '/'];
info.virmen_base = ['/Volumes/Akhil Data/Akhil/RawData/' info.mousename '/virmen/' data_base];
info.imaging_base_path=['/Volumes/Akhil Data/Akhil/RawData/' info.mousename '/' info.date '/'];
info.save_path = ['/Volumes/Akhil Data/Akhil/ProcessedData/' info.mousename '/' info.date '/'];
info.processed_path = ['Volumes/Akhil Data/Akhil/ProcessedData/' info.mousename '/' info.date '/spikes/'];

info.is_stim_dataset = 1; 
% give data inputs!
info.galvo_channel = 7;
info.virmen_channel = 6;
info.vr_sync_string = 'sync_'; %string within VR files to look for so it doesn't read other unnecessary files
...
cd(strcat(info.server,'/Akhil', '/ProcessedData/',num2str(info.mouse),'/',num2str(info.date)));
...
imaging = align_virmen_data_AB(dff,deconv,virmen_it,alignment_info,data,dataCell,trial_its,sounds_per_file,[]);
