...
file
big_gaps = find(digidata_its(file).it_gaps > .05*digidata_its(file).sync_sampling_rate); 
...
end_iti_digidata_time = setdiff(digidata_its(file).locs(find(digidata_its(file).it_gaps >.05*digidata_its(file).sync_sampling_rate & digidata_its(file).it_gaps < .71*digidata_its(file).sync_sampling_rate)),gaps_to_eliminate);%digidata_its(file).locs(find(digidata_its(file).it_gaps >.25*digidata_its(file).sync_sampling_rate & digidata_its(file).it_gaps < .55*digidata_its(file).sync_sampling_rate));
