function [file_digidata_trial_info,file_matching_trials,sound_condition_array2] = match_trialsperfile_pulse_maze(digidata_its, trial_info,sound_condition_array,task_info,data)
...
file
big_gaps = find(digidata_its(file).it_gaps > .025*digidata_its(file).sync_sampling_rate); 
